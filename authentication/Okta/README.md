...
3. Run the `helm install` command.
    ...
    > ```
    > See [Preparing to install](https://ibmdocs-test.dcs.ibm.com/docs/en/odm/9.0.0?topic=production-preparing-install-operational-decision-manager) documentation for additional information.
...
1. Get the ODM endpoints.
    You can refer to the [documentation](https://ibmdocs-test.dcs.ibm.com/docs/en/odm/9.0.0?topic=tasks-configuring-external-access) to retrieve the ODM endpoints.
