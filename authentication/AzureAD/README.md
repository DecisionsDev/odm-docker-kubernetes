...
#### a. Installation on OpenShift using Routes
  ...
  See the [Preparing to install](https://ibmdocs-test.dcs.ibm.com/docs/en/odm/8.12.0?topic=production-preparing-install-operational-decision-manager) documentation for additional information.
...
1. Get the ODM endpoints.
    ...
    Refer to the [documentation](https://ibmdocs-test.dcs.ibm.com/docs/en/odm/8.12.0?topic=production-configuring-external-access) to retrieve the endpoints.
