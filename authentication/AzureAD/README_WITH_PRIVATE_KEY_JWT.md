...
Now you can generate the client_assertion following the [ODM documentation](https://ibmdocs-test.dcs.ibm.com/docs/en/odm/9.0.0?topic=900-generating-json-web-token-client-assertion).
