...
1. Create a role for ODM administrators.
    ...
    For more information about ODM groups and roles, refer to the [ODM on Kubernetes documentation](https://ibmdocs-test.dcs.ibm.com/docs/en/odm/8.12.0?topic=access-user-roles-user-groups).
...
#### a. Installation on OpenShift using Routes
  ...
  See the [Preparing to install](https://ibmdocs-test.dcs.ibm.com/docs/en/odm/8.12.0?topic=production-preparing-install-operational-decision-manager) documentation for more information.
...
1. Get the ODM endpoints.
    Refer to [this documentation](https://ibmdocs-test.dcs.ibm.com/docs/en/odm/8.12.0?topic=production-configuring-external-access) to retrieve the endpoints.
...
For more information, refer to [this documentation](https://ibmdocs-test.dcs.ibm.com/docs/en/odm/8.12.0?topic=designer-importing-security-certificate-in-rule).
