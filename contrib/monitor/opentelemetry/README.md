...
Jaeger will be installed using the [OpenShift Jaeger Operator](https://docs.redhat.com/en/documentation/openshift_container_platform/4.15/html/distributed_tracing/index#distr-tracing-jaeger-operator-install_dist-tracing-jaeger-installing).
