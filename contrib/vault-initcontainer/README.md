...
> Alternatively, you may consider our [Vault InitContainer setup](https://github.com/DecisionsDev/odm-docker-kubernetes/blob/vnext-release/contrib/vault-initcontainer/README.md) as another secure method for managing secrets in Kubernetes. This option is designed to minimize configuration efforts and reduce the workload on your part. We encourage you to explore both configurations to identify which setup aligns better with your operational needs and simplicity preferences.

> Alternatively, you may consider our [Secret Store setup](../secret-store/README.md) as another secure method for managing secrets in Vault. This option is designed to minimize configuration efforts and reduce the workload on your part. We encourage you to explore both configurations to identify which setup aligns better with your operational needs and simplicity preferences.
