...
- [Optional] To use an external OIDC provider with Rule Designer, see [Configuring Rule Designer](https://ibmdocs-test.dcs.ibm.com/docs/en/odm/9.0.0?topic=parties-configuring-rule-designer).
